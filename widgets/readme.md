...
1. Run `./node_modules/.bin/bower update` to get the latest libraries to be packaged with the project (TODO, merge the `packages.json` and `bower.json` systems, probably do not need both)
