        ...
        return {
            ...
            link: function(scope, element) {
                ...
                scope.$on('datacastLoaded', function() {
                    ...
                    scope.lastPlay =
                        scope.playByPlay[scope.playByPlay.length - 1];
                    scope.previousPlay =
                        scope.playByPlay[scope.playByPlay.length - 2];
                ...
                scope.drawField = function() {
                    ...
                    var bottomMiddleHashMarkY =
                        fieldSize.height - hashMarkInset;

                    // build reusable symbols
                    var hashMarkSymbol = new paper.Path.Line(
                        new paper.Point(0, 0),
                        new paper.Point(0, hashMarkHeight)
                    );
                    ...
                    verticalLineSymbol.pivot =
                        verticalLineSymbol.bounds.topLeft;
                    ...
                    thickVerticalLineSymbol.pivot =
                        thickVerticalLineSymbol.bounds.topLeft;
                    thickVerticalLineSymbol = new paper.Symbol(
                        thickVerticalLineSymbol
                    );

                    for (
                        i = 0;
                        i < yardLines.length;
                        yardLineSpacing > 5 ? i++ : (i += 5)
                    ) {
                        // every 5 yards
                        if (i % 5 === 0) {
                            if (i % 10 !== 0) {
                                verticalLineSymbol.place(
                                    new paper.Point(yardLines[i], 0)
                                );
                            } else if (i % 10 === 0) {
                                // every 10 yards
                                thickVerticalLineSymbol.place(
                                    new paper.Point(yardLines[i], 0)
                                );
                                if (i !== 0 && i !== yardLines.length - 1) {
                                    ...
                                    var topYardText10Digit = new paper.PointText(
                                        new paper.Point(
                                            yardLines[i] +
                                                yardLineTextHorizontalPadding +
                                                yardLineWidth -
                                                2,
                                            text10DigitSize.height +
                                                yardLineTextVerticalPadding
                                        )
                                    );
                                    ...
                                    topYardText10Digit.fontSize =
                                        text10DigitSize.height + 'px';
                                    ...
                                    var topYardText0Digit = new paper.PointText(
                                        new paper.Point(
                                            yardLines[i] -
                                                text10DigitSize.width -
                                                yardLineTextHorizontalPadding -
                                                2,
                                            yardText0DigitSize.height +
                                                yardLineTextVerticalPadding
                                        )
                                    );
                                    ...
                                    topYardText0Digit.fontSize =
                                        yardText0DigitSize.height + 'px';
                                    ...
                                    bottomYardText10Digit.fontSize =
                                        text10DigitSize.height + 'px';
                ...
                scope.drawDrive = function() {
                    ...
                    var fieldSize = paper.view.viewSize;
                    var homeTeamIsOnOffense =
                        scope.lastPlay.TeamSeasonId == scope.homeTeamSeasonId;
                    ...
                    if (homeTeamIsOnOffense) {
                        firstDownYardLine =
                            scrimmageYardLine - scope.lastPlay.Distance;
                    } else {
                        firstDownYardLine =
                            scrimmageYardLine + scope.lastPlay.Distance;
                    }
                ...
                scope.drawHashMark = function(symbol, x, y, drawTopToBottom) {
                    symbol.place(
                        new paper.Point(
                            x,
                            drawTopToBottom ? y : y - hashMarkHeight
                        )
                    );
                };
                ...
                scope.getSpot = function(play) {
                    var team =
                        (play.TeamSeasonId == scope.homeTeamSeasonId &&
                            play.Spot <= 50) ||
                        (play.TeamSeasonId == scope.awayTeamSeasonId &&
                            play.Spot > 50)
                            ? scope.homeAcronym
                            : scope.awayAcronym;
