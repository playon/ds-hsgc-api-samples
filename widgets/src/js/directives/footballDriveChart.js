    ...
    return {
      ...
      link: function(scope, element) {
        ...
        scope.drawField = function() {
          ...
          var hashMarkSymbol = new paper.Path.Line(new paper.Point(0, 0), new paper.Point(0, hashMarkHeight));
            ...
            if (i % 5 === 0) {
              if (i % 10 !== 0) {
                ...
                if (i !== 0 && i !== yardLines.length - 1) {
                  ...
                  var topYardText10Digit = new paper.PointText(new paper.Point(yardLines[i] + yardLineTextHorizontalPadding + yardLineWidth - 2, text10DigitSize.height + yardLineTextVerticalPadding));
                  ...
                  var topYardText0Digit = new paper.PointText(new paper.Point(yardLines[i] - text10DigitSize.width - yardLineTextHorizontalPadding - 2, yardText0DigitSize.height + yardLineTextVerticalPadding));
                  ...
                  var bottomYardText10Digit = new paper.PointText(new paper.Point(yardLines[i] - text10DigitSize.width - yardLineTextHorizontalPadding - 1, fieldSize.height - text10DigitSize.height / 2 - yardLineTextVerticalPadding));
                  ...
                  var bottomYardText0Digit = new paper.PointText(new paper.Point(yardLines[i] + yardLineTextHorizontalPadding + yardLineWidth - 1, fieldSize.height - yardText0DigitSize.height / 2 - yardLineTextVerticalPadding));
              ...
              scope.drawHashMark(hashMarkSymbol, yardLines[i], 0, true);
              scope.drawHashMark(hashMarkSymbol, yardLines[i], fieldSize.height, false);
              scope.drawHashMark(hashMarkSymbol, yardLines[i], topMiddleHashMarkY, true);
              scope.drawHashMark(hashMarkSymbol, yardLines[i], bottomMiddleHashMarkY, false);
            }
          }
        };
        ...
        scope.drawHashMark = function(symbol, x, y, drawTopToBottom) {
          symbol.place(new paper.Point(x, drawTopToBottom ? y : y - hashMarkHeight));
        };
