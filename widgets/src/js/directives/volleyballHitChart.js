/* jshint -W014 */
angular.module('hsgc').directive('volleyballHitChart', [
    '$window',
    '$log',
    function($window, $log) {
        return {
            ...
            link: function(scope, element) {
                ...
                var paper =
                        typeof window.paper === 'undefined'
                            ? null
                            : window.paper, // get a local instance of the paper global
                    firstLoad = true,
                ...
                scope.$watch('selectedHitChartPeriod', function(
                    newValue,
                    oldValue
                ) {
            ...
            */
                    ...
                    if (
                        newValue === selectedDetailTabForHitChart &&
                        newValue !== oldValue
                    ) {
                        scope.resize();
                ...
                scope.$on('datacastLoaded', function() {
                    if (firstLoad) {
                        ...
                        vballCourtTooltip = element
                            .parent()
                            .find('.digital-scout-hit-chart-tooltip-js');
                        if (vballCourtTooltip && vballCourtTooltip.length > 0) {
                            vballCourtTooltipInner = $(
                                '.tooltip-inner',
                                vballCourtTooltip
                            );
                        }
                        ...
                        scope.hitTypeFilterList = [
                            ...
                            {
                                DisplayName: 'Top Spin',
                                Value: 'TopSpin',
                                EventType: 'Serve'
                            },
                            {
                                DisplayName: 'All attacks',
                                Value: '',
                                EventType: 'Attack'
                            },
                            {
                    ...
                    angular.forEach(scope.players, function(value, key) {
                        player = {
                            DisplayName:
                                (scope.homeTeamSeasonId == key
                                    ? scope.homeName
                                    : scope.awayName) + ' (all players)',
                            TeamDisplayName:
                                scope.homeTeamSeasonId == key
                                    ? scope.homeName
                                    : scope.awayName,
          ...
          */
                    ...
                    var desiredWidth =
                            ...
                            20 /* hard-coded padding width from the base.less rule ".digital-scout-tab-container > div" */,
                        desiredHeight = 0;
                    ...
                    desiredHeight =
                        (desiredWidth - courtPerimeter.x * 2) / 2 +
                        courtPerimeter.y * 2;
                ...
                scope.clearItems = function() {
                    paper.project.clear();
                    vballPoints = [];
                    vballCourtImgLarge = new paper.Raster(
                        'https://cdn.digitalscout.com/img/volleyball-court-1280x640.png'
                    );
                    vballCourtImgSmall = new paper.Raster(
                        'https://cdn.digitalscout.com/img/volleyball-court-640x320.png'
                    );
                    vballCourtImg = vballCourtImgLarge;
                    vballCourtImgWidth = 1280;
                };
                ...
                scope.addItem = function(data) {
                    ...
                    item.bulletStart = new paper.Path.Circle(
                        origin,
                        circleDrawingRadius
                    );
                    ...
                    // draw the end marker
                    item.bulletEnd = new paper.Path.Circle(
                        destination,
                        circleDrawingRadius * 2
                    );
          ...
          */
                    item.bulletKill2 = new paper.Path.Line(
                        new paper.Point(
                            destination.x - circleDrawingRadius,
                            destination.y + circleDrawingRadius
                        ),
                        new paper.Point(
                            destination.x + circleDrawingRadius,
                            destination.y - circleDrawingRadius
                    ...
                    new paper.Group([
                        item.line,
                        item.bulletStart /*, item.bulletKill1*/,
                        item.bulletKill2,
                        item.bulletEnd
                    ]);
                ...
                scope.buildHitPoints = function(playByPlay, homeTeamSeasonId) {
                    ...
                    for (i = 0; i < playByPlay.length; i++) {
                        ...
                        if (
                            !(
                                play &&
                                (play.EventType === 'Serve' ||
                                    play.EventType === 'Attack') &&
                                play.OriginX &&
                                play.DestinationY
                            ) /* lazily assume that if any Origin and Destination coordinate is non-zero, then they all are */
                        ) {
                        ...
                        scope.addItem({
                            ...
                            origin:
                                play.TeamSeasonId == homeTeamSeasonId
                                    ? [1 - play.OriginX, 1 - play.OriginY]
                                    : [play.OriginX, play.OriginY],
                            destination:
                                play.TeamSeasonId == homeTeamSeasonId
                                    ? [
                                          1 - play.DestinationX,
                                    ...
                                    : [play.DestinationX, play.DestinationY],
                            grade: play.Grade,
                ...
                scope.setSizeOfItemsOnCourt = function() {
                    var view = paper.view,
                        ...
                        courtHeightInView =
                            view.viewSize.height - vballCourtAnchor.y * 2,
                        scale,
                        item,
                        startLine,
                        endLine,
                    ...
                    scale =
                        (paper.view.viewSize.width - courtPerimeter.x * 2) /
                        vballCourtImgWidth;
                    ...
                    if (scale >= 1) {
                        $log.debug(
                            'Not expecting a positive scale of ' +
                                scale +
                                ' based on an image width of ' +
                                vballCourtImgWidth
                        );
                    }
                    ...
                    for (i = 0; i < vballPointsLength; i++) {
                        ...
                        if (
                            !scope.selectedHitChartPeriod ||
                            scope.selectedHitChartPeriod == item.data.period
                        ) {
                        ...
                        if (
                            scope.playerFilter.TeamSeasonId ==
                                item.data.teamSeasonId &&
                            (scope.playerFilter.PlayerId == 0 ||
                                scope.playerFilter.PlayerId ==
                                    item.data.playerId)
                        ) {
                            item.line.visible = true;
                            item.bulletStart.visible = true;
                        ...
                        if (
                            scope.hitTypeFilter.EventType ==
                                item.data.eventType &&
                            (scope.hitTypeFilter.Value == '' ||
                                scope.hitTypeFilter.Value == item.data.hitType)
                        ) {
                            item.line.visible = true;
                            item.bulletStart.visible = true;
                            item.bulletEnd.visible = true;
                        ...
                        startTarget = new paper.Point(
                            vballCourtAnchor.x +
                                courtWidthInView * item.data.origin[0],
                            vballCourtAnchor.y +
                                courtHeightInView * item.data.origin[1]
                        );
                        endTarget = new paper.Point(
                            vballCourtAnchor.x +
                                courtWidthInView * item.data.destination[0],
                            vballCourtAnchor.y +
                                courtHeightInView * item.data.destination[1]
                        );
                        scope.forceMaxEdges(startTarget, {
                            x: viewWidth,
                            y: view.viewSize.height
                        });
                        scope.forceMaxEdges(endTarget, {
                            x: viewWidth,
                            y: view.viewSize.height
                        });
            ...
            */
                        attack2LineStart.point.x +=
                            endTarget.x -
                            circleDrawingRadius -
                            attack2LineStart.point.x;
                        attack2LineStart.point.y +=
                            endTarget.y +
                            circleDrawingRadius -
                            attack2LineStart.point.y;
                        attack2LineEnd.point.x +=
                            endTarget.x +
                            circleDrawingRadius -
                            attack2LineEnd.point.x;
                        attack2LineEnd.point.y +=
                            endTarget.y -
                            circleDrawingRadius -
                            attack2LineEnd.point.y;
                ...
                scope.hitOnEnter = function(evt) {
                    ...
                    if (topPositionX - halfOfTooltipWidth < 5) {
                        vballCourtTooltip
                            .removeClass('top left right')
                            .addClass('right')
                            .css(
                                'top',
                                Math.round(
                                    tgt.position.y -
                                        vballCourtTooltip.height() / 2
                                ) + 'px'
                            )
                            .css('left', Math.round(tgt.position.x + 5) + 'px');
                    } else if (
                        tgt.position.x + halfOfTooltipWidth >
                        paper.view.viewSize.width - 5
                    ) {
                        vballCourtTooltip
                            .removeClass('top left right')
                            .addClass('left')
